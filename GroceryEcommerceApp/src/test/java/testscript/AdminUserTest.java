...
public class AdminUserTest extends Base {
	...
	public void verifyTheUserIsAbleToCreateAdminUserDetails() throws IOException {
		...
		adminpage = homepage.AdminMoreInfo().NewButton().EnterText(userName).EnterText1(confirmUserName).selectUserType(userType)
			    .SaveButton();
		...
		adminpage.NewButton();
		adminpage.EnterText("Rachana");
		adminpage.EnterText1("Rachana");
